...
I didn't have to wonder for long. That evening, almost by accident, I opened Digital Wellbeing. The numbers stared back at me like a verdict: Instagram at an all-time high of **5 hours** on average. WhatsApp at **1.5 hours** — but the truly unsettling part wasn't the time, it was the **250 times** I had opened it throughout the day. Games clocked in at another **2.5 hours**.
...
That discomfort was the signal I needed. I sat down in front of my laptop, started drafting a dopamine detox plan, and began writing this.

### Protocol

This is the protocol I will be following until the end of the year.

1. **Instagram**: Deleted from all devices, completely.
...
We are not perfect. There may come a time when I reinstall those apps and chase those dopamine spikes again — it's entirely possible. But this experiment means a lot to me, and a slip doesn't have to mean the end.
...
I anticipate this will happen, especially in the beginning. Usually, I use music to drown out weird or sad thoughts. Now, I will face them. I plan to simply observe them without reacting, and see if the silence eventually helps me process them better.

But if things go too far south, I won't just sit and suffer. I'll pull myself out by stepping into a hobby, taking a walk in nature, or watching something on TV — and then journal it out somewhere I can be completely honest with myself. No bottling it up, just getting it out of my head and onto the page.

I believe that over time, these thoughts will diminish. The silence that once felt uncomfortable will start to feel like home.

### What about accidental music? 

If I go to a mall or a cafe and music is playing, I won’t run away. I simply won’t focus on it. The goal is to remove the choice to listen, not to fear the environment.

### Baseline Tests

Before I begin, I want to establish a baseline — an honest snapshot of where my brain is right now, before the experiment changes anything.

I ran two sets of tests:

**Human Benchmark** — a cognitive test suite measuring different aspects of brain performance. Eight tests in total:

- **Chimp Test**: How well you remember and sequence visual information, like a chimpanzee memory task.
- **Visual Memory**: How many tiles you can remember and recall on a grid.
- **Number Memory**: The longest number you can hold in your working memory.
- **Sequence Memory**: How long you can follow and repeat a growing pattern.
- **Verbal Memory**: How many words you can remember across repeated rounds.
- **Reaction Time**: How fast you respond to a visual stimulus.
- **Typing**: How fast and accurately you type, measured in words per minute.
- **Aim Trainer**: How quickly you can click on targets — a measure of motor precision and focus.

**Mental Health Baseline** — six standardised tests measuring different dimensions of mental wellbeing:

- **WHO-5 Well-Being Index**: Overall psychological wellbeing, scored out of 100.
- **GAD-7**: Measures anxiety severity, scored out of 21.
- **PHQ-9**: Screens for depression severity, scored out of 27.
- **Athens Insomnia Scale (AIS)**: Measures sleep quality, scored out of 24. A score above 6 indicates insomnia.
- **Brief Resilient Coping Scale (BRCS)**: Measures how well you cope with stress, scored out of 20.
- **Perceived Stress Scale (PSS)**: Measures how stressed you feel in general, scored out of 40.
...
- [Mental Health Tests](https://www.mymentalhealth.guide/get-tested)


### My Hypothesis

I am treating this strictly as an experiment, and every experiment needs a hypothesis.

By removing the constant dopamine hits — the reels, the music, the games, the endless scrolling — I believe my baseline tolerance for boredom will increase. And when the brain is bored enough, it stops waiting for entertainment to arrive. It starts making its own. That is when it reaches for coding, reading, mathematics, writing — things that are harder, slower, and infinitely more rewarding.

I also believe that silence is necessary for original thought. Every waking hour filled with noise is an hour the brain never gets to process what it has already taken in. Strip that away, and something shifts. Thoughts connect differently. Ideas that were buried under the noise start surfacing on their own.

The first 2–3 weeks will likely be brutal — withdrawal, restlessness, and phantom music playing in my head even when the room is completely silent. That last part is real, and I am genuinely curious to see how long it lasts.

But by Month 3, my hypothesis is this: clearer thinking, sharper focus, and a mind that no longer needs external noise to function. A brain that has learned to be comfortable in its own company.

We will see.

### The End Game

This experiment is not about perfection.
...
1. Mood (Scale of 1-10)
2. Focus (Scale of 1-10)
3. Urge to relapse (Scale of 1-10)
4. Any phantom music? (If yes mention the song names)
5. Daily summary and any notes if required (just a brief summary of the day wrt the dopamine detox)
